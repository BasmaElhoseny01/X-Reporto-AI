...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        try:
            ...
            # denoiser targets
            denoiser_sample = {}    
            denoiser_sample["image"]=transformed_image
    ...
    def collate_fn(self,batch):
        ...
        for i in range(len(batch)):
            (denoiser_target,object_detector_batch,selection_classifier_batch,abnormal_classifier_batch,LM_batch) = batch[i]
            # stack images
            images[i] = denoiser_target['image']
