...
def init_working_space():
    ...
    if not os.path.exists(models_folder_path):
        ...
        print(f"Folder '{models_folder_path}' created successfully.")
    else:
    ...
    if not os.path.exists(ck_folder_path):
        ...
        print(f"Folder '{ck_folder_path}' already exists.")
...
if __name__ == '__main__':
    ...
    setup_logging(log_file_path='/content/Graduation-Project-editing/logs/heat_map_trainer.log',bash=True,periodic_logger=PERIODIC_LOGGING)
